 ...
 * Задача: Створювати об'єкти без визначення конкретних класів клієнтом
...
export function demonstrateFactoryMethod(): void {
  ...
  console.log(
    "✅ Factory Method дозволяє клієнту створювати об'єкти без залежності від конкретних класів\n"
  );
}
